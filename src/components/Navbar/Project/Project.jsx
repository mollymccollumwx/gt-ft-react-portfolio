    ...
    const [projects, setProject] = useState([
        {
          ...
          },
          {
            ...
            url: "https://github.com/mollymccollumwx/react-employee-directory/tree/gh-pages",
            github: "https://github.com/mollymccollumwx/react-employee-directory/tree/main/employee-directory",
            image: Directory,
            id: "3"
          },
          {
              ...
              <div className="container">
                <div className="columns">
                  ...
                  <div className="column is-4">
                    ...
                    <a className="button is-dark is-medium mr-2" href={project.url}>
                      Application
                    </a>
                    <a className="button is-info is-medium ml-2" href={project.github}>
                      GitHub
                    </a>
                  </div>
